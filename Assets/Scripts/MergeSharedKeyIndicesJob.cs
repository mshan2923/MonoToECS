...
namespace Samples.Boids
{
    ...
    public static class JobNativeMultiHashMapUniqueHashExtensions
    {
        ...
        {
            [ReadOnly] public NativeParallelMultiHashMap<int, int> HashMap;//[ReadOnly] public NativeMultiHashMap<int, int> HashMap;
            public T JobData;
        }
        ...
        public static unsafe JobHandle Schedule<T>(this T jobData, NativeParallelMultiHashMap<int, int> hashMap,//public static unsafe JobHandle Schedule<T>(this T jobData, NativeMultiHashMap<int, int> hashMap,
                ...
                while (true)
                {
                    ...
                    for (int i = begin; i < end; i++)
                    {
                        ...
                        while (entryIndex != -1)
                        {
                            ...
                            NativeParallelMultiHashMapIterator<int> it;//NativeMultiHashMapIterator<int> it;
